      ...
      messages: {
        ua: {
          ...
          aboutusParahprahs: [
            ...
            'Наразі матеріальної допомоги потребує переважна більшість громадян України. На головному екрані ви можете знайти анкети людей, які потребують допомоги як ніколи раніше і будь-який переказ коштів допоможе їм.',
        ...
        en: {
          ...
          creationLimitExceeded: 'You have already created a post',
        ...
        ru: {
          ...
          aboutusParahprahs: [
            ...
            'Сейчас в материальной помощи нуждается подавляющее большинство граждан Украины. На главном экране вы можете найти анкеты людей, которые нуждаются в помощи как никогда раньше и любой перевод денежных средств поможет им.',
          ...
          creationLimitExceeded: 'Вы уже создали запись',
